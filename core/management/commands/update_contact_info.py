...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not created:
            ...
            site_settings.phone = '+91 9616651137'
            site_settings.email = 'abdurrabkhan709@gmail.com'
            site_settings.address = 'Lucknow, Uttar Pradesh, India'
            site_settings.whatsapp_number = '919616651137'
            site_settings.save()
        ...
        if not created:
            # Update existing record
            contact_info.phone = '+91 9616651137'
            contact_info.email = 'abdurrabkhan709@gmail.com'
            contact_info.address = 'Lucknow, Uttar Pradesh, India'
            contact_info.whatsapp_number = '919616651137'
            contact_info.save()
